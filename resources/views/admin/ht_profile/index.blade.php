            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <a href="">
                                <a href="{{route('admin.profile.ht.create')}}" class="btn btn-oval btn-success">Create</a>
                            </a>
                        </div>
                                    ...
                                    @foreach($brands as $c)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="{{route('admin.profile.ht.edit',$c->id)}}" class="btn btn-pill-left btn-info d-inline">Edit</a>
                                                <form action="{{route('admin.profile.ht.destroy',$c->id)}}" class="d-inline" method="post">
                                                    {{csrf_field()}}
                                                    {{method_field('Delete')}}
