                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">Tech Caetgory</div>
                        </div>
                        <div class="card-body">
                            <a href="">
                                <a href="{{route('admin.region.create')}}" class="btn btn-oval btn-success">Create Region</a>
                            </a>
                        </div>
                                    ...
                                    @foreach($brands as $c)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="{{route('admin.region.edit',$c->id)}}" class="btn btn-pill-left btn-info d-inline">Edit</a>
                                                <form action="{{route('admin.region.destroy',$c->id)}}" class="d-inline" method="post">
                                                    {{csrf_field()}}
                                                    {{method_field('Delete')}}
